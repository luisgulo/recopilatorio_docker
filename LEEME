...
- [Proyectos](#proyectos)
  - [Trabajar con Contenedores](#operar-con-contenedores)
    - [Creacion de Contenedores](#creacion-de-contenedores)
    - [Despliegue e Infraestructura](#despliegue-e-infraestructura)
    - [Monitorizacion](#monitorizacion)
    - [Redes](#redes)
    - [Orquestacion](#orquestacion)
    - [PaaS Plataforma como Servicio](#paas-plataforma-como-servicio)
    - [Proxy Inverso](#proxy-inverso)
    - [Ejecucion](#ejecucion)
    - [Seguridad](#seguridad)
    - [Descubrimiento de Servicios](#descubrimiento-de-servicios)
    - [Gestion de Volumenes / Datos](#gestion-de-volumenes--datos)
  ...
  - [Imagenes Docker](#imagenes-docker)
    ...
    - [Validador o Linter](#validador-o-linter)
    - [Metadatos](#metadatos)
    - [Registry](#registry)
  - [Desarrollo con Docker](#desarrollo-con-docker)
    ...
    - [Limpiar Contenedores](#limpiar-contenedores)
    - [Sin Servidor serverless](#sin-servidor-serverless)
    - [Chequeos y Estres](#chequeos-y-estres)
    - [Wrappers](#wrappers)
  - [Servicios Basados en Docker](#servicios-basados-en-docker)
...
- [Imagenes Docker](https://hub.docker.com)
...
- [Maestro](https://github.com/toscanini/maestro) 👎 - Maestro provides the ability to easily launch, orchestrate and manage multiple Docker containers as single unit by [@tascanini](https://github.com/toscanini)
...
- [Dynatrace](https://www.dynatrace.com/technologies/docker-monitoring/) 💶 - Monitor containerized applications without installing agents or modifying your Run commands
...
- [SuperVisor CPM](https://t0xic0der.medium.com/simply-accessible-container-performance-monitoring-with-supervisor-7fb47f925f3b) [Frontend Service](https://github.com/t0xic0der/supervisor-frontend-service/) and [Driver Service](https://github.com/t0xic0der/supervisor-driver-service/) 🚧 - A simple and accessible FOSS container performance monitoring service written in Python by [@t0xic0der](https://github.com/t0xic0der/)
...
- [Marathon](https://github.com/mesosphere/marathon) - Marathon is a private PaaS Plataforma como Servicio built on Mesos. It automatically handles hardware or software failures and ensures that an app is "always on"
...
- [Atlantis](https://github.com/ooyala/atlantis) 👎 - Atlantis is an Open Source PaaS Plataforma como Servicio for HTTP applications built on Docker and written in Go
...
- [Convox Rack](https://github.com/convox/rack) - Convox Rack is open source PaaS Plataforma como Servicio built on top of expert infrastructure automation and devops best practices.
- [Dcw](https://github.com/pbertera/dcw) - Docker-compose SSH wrapper: a very poor man PaaS Plataforma como Servicio, exposing the docker-compose and custom-container commands defined in container labels.
...
- [Empire](https://github.com/remind101/empire) - A PaaS Plataforma como Servicio built on top of Amazon EC2 Container Service (ECS)
...
- [Hephy Workflow](https://github.com/teamhephy/workflow) - Open source PaaS Plataforma como Servicio for Kubernetes that adds a developer-friendly layer to any Kubernetes cluster, making it easy to deploy and manage applications. Fork of [Deis Workflow](https://github.com/deis/workflow)
...
- [OpenShift][openshift] - An open source PaaS Plataforma como Servicio built on [Kubernetes][kubernetes] and optimized for Dockerized app development and deployment by [Red Hat](https://www.redhat.com/en)
...
- [Deepfence Enterprise](https://deepfence.io) 💶 - Full life cycle Cloud Native Workload Protection platform for kubernetes, virtual machines and serverless. By [@deepfence](deepfence)
...
- [Phonito Security](https://phonito.io/?b=b) 💶 - a Docker vulnerability scanner with constant Kubernetes monitoring and pipeline integration.
- [Prisma Cloud](https://www.paloaltonetworks.com/prisma/cloud) 💶 - (previously Twistlock Security Suite) detects vulnerabilities, hardens container images, and enforces security policies across the lifecycle of applications.
...
- [Sysdig Secure](https://sysdig.com/products/secure/runtime-security/) 💶 - Sysdig Secure addresses run-time security through behavioral monitoring and defense, and provides deep forensics based on open source Sysdig for incident response.
- [Trend Micro DeepSecurity](https://www.trendmicro.com/en_us/business/products/hybrid-cloud/deep-security.html) 💶 - Trend Micro DeepSecurity offers runtime protection for container workloads and hosts as well as preruntime scanning of images to identify vulnerabilities, malware and content such as hardcoded secrets.
...
- [Storidge](https://github.com/Storidge/quick-start) 💶 - Software-defined Persistent Storage for Kubernetes and Docker Swarm
...
- [DockerSurfer](https://github.com/Simone-Erba/DockerSurfer) 👎 - A web service for analyze and browse dependencies between Docker images in the Docker registry, by [@Simone-Erba](https://github.com/Simone-Erba/)
...
- [Yacht](https://github.com/SelfhostedPro/Yacht) 🚧 - A Web UI for docker that focuses on templates and ease of use in order to make deployments as easy as possible. By [@SelfhostedPro](https://github.com/SelfhostedPro)
...
- [Production-Ready Python Containers 💶](https://pythonspeed.com/products/pythoncontainer/) - A template for creating production-ready Docker images for Python applications.
...
- [dockmoor](https://github.com/MeneDev/dockmoor) 🚧 - Manage docker image references and help to create reproducible builds with Docker. By [@MeneDev](https://github.com/MeneDev)
...
- [Azure Container Registry 💶](https://azure.microsoft.com/en-us/services/container-registry/) - Manage a Docker private registry as a first-class Azure resource
...
- [Cloudsmith 💶](https://cloudsmith.com/docker-registry/) - A fully managed package management SaaS, with first-class support for public and private Docker registries (and many others, incl. Helm charts for the Kubernetes ecosystem). Has a generous free-tier and is also completely free for open-source.
...
- [Dist 💶](https://www.dist.cloud/product/container-registry/) - Private cloud-based Docker container registry
...
- [Screwdriver 💶](https://screwdriver.cd/) - Yahoo's OpenSource buildplatform designed for Continous Delivery.
...
- [Koyeb](https://www.koyeb.com/) 💶 - Koyeb is a developer-friendly serverless platform to deploy apps globally. Seamlessly run Docker containers, web apps, and APIs with git-based deployment, native autoscaling, a global edge network, and built-in service mesh and discovery.
...
- [CodeShip](https://www.cloudbees.com/products/codeship) 💶 - Work with your established Docker workflows while automating your testing and deployment tasks with our hosted platform dedicated to speed and security.
- [ConcourseCI](https://concourse-ci.org) 💶 - A CI SaaS platform for developers and DevOps teams pipeline oriented.
- [Semaphore CI](https://semaphoreci.com/) 💶 — A high-performance cloud solution that makes it easy to build, test and ship your containers to production.
...
- [Appfleet](https://appfleet.com/) 💶 - Edge platform to deploy and manage containerized services globally. The system will route the traffic to the closest location for lower latency.
...
- [Giant Swarm](https://www.giantswarm.io/) 💶 - Simple microservice infrastructure. Deploy your containers in seconds.
...
- [Mesosphere DC/OS Platform](https://d2iq.com/products/dcos) 💶 - Integrated platform for data and containers built on Apache Mesos by [@mesosphere](https://d2iq.com)
...
- [Become a Docker Power User with Visual Studio Code](https://www.thebyte.io/become-docker-power-user-with-vs-code) - 💶 A training course to help you become a Docker Power user with Visual Studio Code
- [Cloud Native Landscape](https://github.com/cncf/landscape)
- [Docker Certification](https://intellipaat.com/docker-training-course/) 💶 will help you to will Learn Docker containerization, running Docker containers, Image creation, Dockerfile, Docker orchestration, security best practices, and more through hands-on projects and case studies and helps to clear Docker Certified Associate.
